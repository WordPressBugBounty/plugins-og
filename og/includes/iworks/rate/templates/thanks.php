	...
	<div class="<?php echo esc_attr( implode( ' ', $args['classes'] ) ); ?>">
		...
		?>
			...
			/* translators: %s is a plugin name wrapped by strong html tag */
				esc_html__( 'Thank you for using our plugin %s!', 'og' ),
...
?>
		<div class="iworks-rate-buttons">
			<a data-action="get-help" href="<?php echo esc_url( $args['support_url'] ); ?>/#new-post" target="_blank" class="iworks-rate-button iworks-rate-button--green" ><?php echo esc_html__( 'Get help', 'og' ); ?></a>
<?php if ( intval( $args['rated'] ) === 0 ) { ?>
			<a data-action="add-review" href="<?php echo esc_url( $args['support_url'] ); ?>/reviews/?rate=5#new-post" target="_blank" class="iworks-rate-button iworks-rate-button--green" ><?php echo esc_html__( 'Add review', 'og' ); ?></a>
<?php } ?>
			<a data-action="donate" href="https://ko-fi.com/iworks/?utm_source=<?php echo esc_url( $args['slug'] ); ?>&utm_medium=notice-thanks" target="_blank" class="iworks-rate-button iworks-rate-button--green dashicons-heart" ><?php echo esc_html__( 'Provide us a coffee', 'og' ); ?></a>
<?php if ( intval( $args['rated'] ) === 0 ) { ?>
			<button type="button" data-action="hide" class="iworks-rate-button iworks-rate-button--blue" ><?php echo esc_html__( 'I added review, do not show again', 'og' ); ?></button>
<?php } ?>
		</div>
	</div>
</div>
