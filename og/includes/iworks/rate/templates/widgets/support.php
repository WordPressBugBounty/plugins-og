...
?>
<a href="<?php echo esc_url( $args['support_url'] ); ?>" target="_blank" class="iworks-rate-button iworks-rate-button--blue" ><?php echo esc_html__( 'Get help', 'og' ); ?></a>
<?php
echo '</p>';
echo '<p>';
echo wp_kses_post(
...
echo '<p class="iworks-rate-center">';
?>
<a href="<?php echo esc_url( add_query_arg( 'rate', '5', $args['support_url'] . '/reviews/' ) ); ?>#new-post" target="_blank" class="iworks-rate-button iworks-rate-button--blue" ><?php echo esc_html__( 'Add review', 'og' ); ?></a>
</p>
